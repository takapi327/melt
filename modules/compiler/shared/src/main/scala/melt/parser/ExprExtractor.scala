...
private[parser] object ExprExtractor:
  ...
  /** Extracts a Scala expression that may contain inline HTML template fragments.
    ...
    * and represented as [[melt.ast.InlineTemplatePart.Html]].
    *
    * @param posBuilder shared [[melt.NodePositions.Builder]] that receives source-span
    *                   entries for every [[melt.ast.TemplateNode]] parsed inside
