...
object Document:
  ...
  /** Sets the document title from a State. */
  ...
  /** One-way binding: `document.visibilityState → State[String]` (read-only).
    *
  ...
  /** One-way binding: `document.fullscreenElement → State[Option[dom.Element]]` (read-only).
    *
    ...
    */
  def bindFullscreenElement(v: State[Option[dom.Element]]): Unit =
  ...
  /** One-way binding: `document.pointerLockElement → State[Option[dom.Element]]` (read-only).
    *
    * Mirrors Svelte 5's `bind_property('pointerLockElement', 'pointerlockchange', document, set)`.
    */
  def bindPointerLockElement(v: State[Option[dom.Element]]): Unit =
  ...
  /** One-way binding: `document.activeElement → State[Option[dom.Element]]` (read-only).
    *
    ...
    */
  def bindActiveElement(v: State[Option[dom.Element]]): Unit =
